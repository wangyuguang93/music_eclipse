...
public class MusicSearch implements music_API{
	...
	private void onSearchResult(List<Network_Musicinfo> resualt) {
...
//					+ pageNo + "&query=";
	...
	public List<Network_Musicinfo> searchSync(String keys) {
		InputStream inStream = null;
		List<Network_Musicinfo> resualt = null;
		try {
			mUrl = musicapi1;
	...
	class SearchThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				List<Network_Musicinfo> resualt = SearchResualtPaser.parse(inStream);
