...
public class MainActivity extends SlidingFragmentActivity
		implements OnClickListener, OnItemSelectedListener, Funhui, Funhui_net {
	private File dir;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// testbendi[i] =MediaUtil.getArtwork(MainActivity.this,musicid[i],
		// music_albumId[i], true, true);
		// }
		// }
		// });
		// thread.start();
	...
	public void yincang() {
		if (bendiFrament != null) {
			// bendiFrament=(BendiFragment)
			// fragmentManager.findFragmentByTag("bendiFrament");
			fragmentTransaction.hide(bendiFrament);
			Log.d("test", "隐藏bendiFrament");
		}
		if (netfragment != null) {
			// netfragment=(Network_fragment)
			// fragmentManager.findFragmentByTag("netfragment");
	...
	public void myplay() {
		...
		if (isplay && hg == musicIndex) {
			...
			musicservice.play(data, lujin, musicIndex, tv_duration, tv_currentposition, tv_music_title,
					pb_music_progress, MainActivity.this, islast, danqian, tv_guqu_num, musicid, music_albumId, img_ico,
					bendi_tupian);
	...
	public void fanhuiView(View view) {
		...
		if (!is_updateListview) {
			// musicAdpater=new MusicAdpater(this,
			// bendata,listView,musicIndex,musicid,music_albumId);
	...
	public void fanhuiView_net(View view) {
		...
		// networkAdapter_item=new
		// NetworkAdapter_item(MainActivity.this,net_song_name,net_author,bitmap);
		//
		// }
		/**
		 * 下拉测试
		...
		networklistview.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				// TODO Auto-generated method stub
				if (lastItem == networklistview.getCount() - 1 && scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
					...
					if (page <= 5 && isjiazai&&arr.length%20==0) {
			...
			public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
				...
				// Log.i("屏幕滚动","firstVisibleItem:"+firstVisibleItem+"visibleItemCount:"+visibleItemCount+"
				// lastItem:"+lastItem+"networklistview.getCount:"+networklistview.getCount());
			}
		});
		// 点击事件
